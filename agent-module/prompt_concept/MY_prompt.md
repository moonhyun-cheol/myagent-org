...
0. **Live brand manual** injected this turn (`ORGANIZATION BRAND MANUAL` from `http://192.168.1.248:8080/api/brand-manual/current.md`). Brand philosophy, PAA, line language: this wins over static snapshots.
