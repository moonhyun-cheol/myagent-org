...
NAS_DEV = Path(r"\\Nas\공용_시장조사팀\01_상품기획파트\05_상품개발\CQR개발방향_260522.xlsx")
NAS_PO = Path(r"\\Nas\공용_시장조사팀\01_상품기획파트\02_기획-상품관리\03_상품관리_발주서\2_CLOTHING")
...
def resolve_dev_xlsx() -> Path | None:
    ...
    candidates.extend(
        [
            LOCAL_SOURCE / "CQR개발방향_260522.xlsx",
            LOCAL_SOURCE / "cqr_development_direction.xlsx",
            CONCEPT_ROOT / "CQR개발방향_260522.xlsx",
            NAS_DEV,
        ]
    )
...
def main() -> None:
    ...
    if dev:
        ...
        msg = (
            ...
            "Copy CQR개발방향_260522.xlsx to data/source/ or set CQR_DEV_XLSX env var."
        )
